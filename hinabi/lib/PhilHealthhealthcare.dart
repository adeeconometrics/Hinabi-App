...
import './PhilHealthinstitution.dart';
import 'package:flutter_svg/flutter_svg.dart';
import './PhilHealthemployers.dart';
import './PhilHealthcollectingpartner.dart';

class PhilHealthhealthcare extends StatelessWidget {
  PhilHealthhealthcare({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(1.2, 0.0, 364.0, 160.0),
                    size: Size(365.2, 167.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(25.0, 13.0, 266.0, 24.0),
                          size: Size(364.0, 160.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(55.5, 67.0, 280.5, 93.0),
                          size: Size(364.0, 160.0),
                          pinRight: true,
                          pinBottom: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 364.0, 160.0),
                          size: Size(364.0, 160.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 364.3, 167.0),
                    size: Size(365.2, 167.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
...
const String _svg_1z52fj =
    '<svg viewBox="23.8 386.0 364.3 167.0" ><defs><filter id="shadow"><feDropShadow dx="1" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(23.84, 386.0)" d="M 6.154129505157471 0 L 358.1703491210938 0 C 361.5691528320313 0 364.324462890625 4.200474739074707 364.324462890625 9.382022857666016 L 364.324462890625 157.6179809570313 C 364.324462890625 162.7995300292969 361.5691528320313 167 358.1703491210938 167 L 6.154129505157471 167 C 2.755297422409058 167 0 162.7995300292969 0 157.6179809570313 L 0 9.382022857666016 C 0 4.200474739074707 2.755297422409058 0 6.154129505157471 0 Z" fill="none" stroke="#95a2b6" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
