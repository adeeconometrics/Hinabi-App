...
class Pagibigbenefits1 extends StatelessWidget {
  Pagibigbenefits1({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(1.2, 0.0, 364.0, 192.0),
                    size: Size(365.2, 192.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(25.0, 13.0, 311.0, 24.0),
                          size: Size(364.0, 192.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(45.0, 49.0, 311.0, 126.0),
                          size: Size(364.0, 192.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 364.0, 192.0),
                          size: Size(364.0, 192.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 364.3, 192.0),
                    size: Size(365.2, 192.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
...
const String _svg_bqipbn =
    '<svg viewBox="23.8 386.0 364.3 192.0" ><defs><filter id="shadow"><feDropShadow dx="1" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(23.84, 386.0)" d="M 6.154129505157471 0 L 358.1703491210938 0 C 361.5691528320313 0 364.324462890625 4.829288005828857 364.324462890625 10.78651714324951 L 364.324462890625 181.2134857177734 C 364.324462890625 187.1707153320313 361.5691528320313 192 358.1703491210938 192 L 6.154129505157471 192 C 2.755297422409058 192 0 187.1707153320313 0 181.2134857177734 L 0 10.78651714324951 C 0 4.829288005828857 2.755297422409058 0 6.154129505157471 0 Z" fill="none" stroke="#95a2b6" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
